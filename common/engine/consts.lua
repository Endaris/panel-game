...
-- the amount of time the garbage attack animation plays before getting to the telegraph
consts.GARBAGE_TRANSIT_TIME = 45
-- the amount of time the garbage stays in the telegraph after getting there from the attack animation
consts.GARBAGE_TELEGRAPH_TIME = 45
-- this is the amount of time after garbage leaves the telegraph before it can land on the opponent
...
consts.GARBAGE_DELAY_LAND_TIME = 60 
consts.GARBAGE_STAGING_DURATION = consts.GARBAGE_TELEGRAPH_TIME + consts.GARBAGE_TRANSIT_TIME
-- maximum amount of lag before net games abort
consts.MAX_LAG = 155 + consts.GARBAGE_STAGING_DURATION
