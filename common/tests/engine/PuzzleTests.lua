...
function PuzzleTests.validationCountdown()
  local puzzle = Puzzle("moves", "5", "1254216999999952", "idc")
...
function PuzzleTests.validationPuzzleType()
  local puzzle = Puzzle("garbageGoal", "5", "1254216999999952")
  local isValid, validationMessage = puzzle:validate()
...
function PuzzleTests.validationMoves()
  local puzzle = Puzzle("moves", 0, "1254216999999952")
  local isValid, validationMessage = puzzle:validate()
...
function PuzzleTests.validationStackCharacters()
  local puzzle = Puzzle("moves", 3, "12542169999f9952")
  local isValid, validationMessage = puzzle:validate()
...
function PuzzleTests.validationStackLength()
  local puzzle = Puzzle("moves", 2, "1254216999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999952")
  local isValid, validationMessage = puzzle:validate()
...
function PuzzleTests.validationStackLength2()
  local puzzle = Puzzle("clear", 3, "[==================================]000060500014600011300024502542203135466243")
...
function PuzzleTests.validationGarbageCoherence1()
  local puzzle = Puzzle("moves", 2, "929999[==========}040000224999949999")
  local isValid, validationMessage = puzzle:validate()
...
function PuzzleTests.validationGarbageCoherence4()
  local puzzle = Puzzle("moves", 2, "9299[===]99040000224999949999")
  local isValid, validationMessage = puzzle:validate()
...
function PuzzleTests.testFilledPuzzleString()
  local puzzle = Puzzle("moves", 5, "123")
...
function PuzzleTests.testHorizontallyFlippedPuzzle()
  local puzzleString = "{====}929999[====]040000224999949999"
  local puzzle = Puzzle("moves", 5, puzzleString)
