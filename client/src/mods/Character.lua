...
---@enum PopFxStyle
local popFxStyle = { BURST = "burst" }

---@enum MusicStyle
local musicStyle = { NORMAL = "normal", DYNAMIC = "dynamic" }
...
---@field popfx_style PopFxStyle defines a style in which attacks and pops are accompanied by select graphic assets
...
---@field music_style MusicStyle defines the behaviour for music when switching between normal and danger
